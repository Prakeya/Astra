...
export function WalkMode() {
  ...
  const querySafestRoute = async (from: string, to: string, isRefresh = false) => {
    ...
    try {
      ...
      setSafetyMetrics({
        safe: {
          lighting: "92% Illuminated Corridor",
          population: "Active Main Avenue",
          incidents: "0 active high-threat warnings on detour",
          description: "Safest route detour selected avoiding reported caution sectors."
        },
        shortest: {
          lighting: "50% Standard Lighting",
          population: "Back Alley Shortcut",
          incidents: "Caution flags detected",
