...
export function SOSScreen() {
  ...
  // Automatically record SOS emergency trigger in safety database
  useEffect(() => {
    const center = getMapCenterFromUser();
    addComplaint({
      type: "emergency_sos",
      label: "Emergency SOS Alert",
      severity: "Critical",
      description: "Distress signal triggered by user. Emergency broadcast active.",
      anonymous: false,
      lat: center.lat,
      lng: center.lng,
      locationName: "Active SOS Location (Broadcasting)",
      isSos: true
    });
  }, []);
